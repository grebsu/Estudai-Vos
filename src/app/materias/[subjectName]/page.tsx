...
export default function MateriaDetalhes() {
  ...
  useEffect(() => {
    ...
    fetchPlanAndRecords();
  }, [selectedDataFile, initialFileName]);
  ...
  const studiedTopics = useMemo(() => {
    ...
    return currentSubject?.topics.filter(topic => studiedTopicTexts.has(topic.topic_text)).length || 0;
          ...
          {currentSubject.topics.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white dark:bg-gray-700">
                <thead>
                  <tr>
                    <th className="py-2 px-4 border-b border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Número</th>
                    <th className="py-2 px-4 border-b border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Tópico</th>
