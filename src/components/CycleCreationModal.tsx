        ...
        return (
          <div className="text-center bg-white dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div onClick={() => setModalStep(1)} className="group border-2 border-gray-200 hover:border-gold-500 p-6 rounded-lg cursor-pointer transition-all duration-300 transform hover:scale-105 dark:border-gray-700 dark:hover:border-gold-400">
                <FaMagic className="text-4xl text-gold-500 mx-auto mb-4 transition-transform duration-300 group-hover:rotate-12 dark:text-gold-400" />
              ...
              <div onClick={() => setModalStep(4)} className="group border-2 border-gray-200 hover:border-orange-500 p-6 rounded-lg cursor-pointer transition-all duration-300 transform hover:scale-105 dark:border-gray-700 dark:hover:border-orange-400">
                <FaTools className="text-4xl text-orange-500 mx-auto mb-4 transition-transform duration-300 group-hover:rotate-12 dark:text-orange-400" />
        ...
        return (
          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg">
              ...
              <div className="flex flex-col">
                ...
                <div className="relative mb-4">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 text-gray-900 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600 dark:focus:ring-gold-400"
                  />
                </div>
                ...
                <div className="space-y-2 overflow-y-auto pr-2" style={{ maxHeight: '260px' }}>
                  {filteredSubjects.map(s => (
                    <div
                      ...
                      className={`p-3 rounded-lg cursor-pointer transition-all duration-200 flex justify-between items-center ${selectedSubjects.includes(s.subject) ? 'bg-gold-100 text-gold-800 font-semibold dark:bg-gold-800 dark:text-gold-100' : 'bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-100'}`}>
                      <span className="text-gray-800">{s.subject}</span>
                      {selectedSubjects.includes(s.subject) && <FaCheckCircle className="text-gold-500 dark:text-gold-400" />}
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="flex justify-between mt-8">
              ...
              <button onClick={() => setModalStep(2)} className="px-6 py-2 bg-gold-500 text-white font-semibold rounded-lg hover:bg-gold-600 transition-colors dark:bg-gold-600 dark:hover:bg-gold-700" disabled={selectedSubjects.length === 0}>Avançar</button>
            </div>
          </div>
        );
      case 2:
        ...
        return (
          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg">
                ...
                {selectedSubjects.map(subject => (
                  <div key={subject} className="p-4 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 relative">
                    ...
                    <button
                      ...
                      className="absolute top-2 right-2 text-gray-400 hover:text-gold-500 dark:hover:text-gold-400 transition-colors"
            ...
            <div className="flex justify-between mt-8">
              ...
              <button onClick={() => setModalStep(3)} className="px-6 py-2 bg-gold-500 text-white font-semibold rounded-lg hover:bg-gold-600 transition-colors dark:bg-gold-600 dark:hover:bg-gold-700">Avançar</button>
            </div>
          </div>
        );
      case 3:
        return (
          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div className="space-y-6">
                <div>
                  <label className="block text-lg font-semibold text-gray-700 dark:text-gray-100 mb-2 flex items-center">
                    <FaClock className="mr-3 text-gold-500" />
                    Horas Semanais
                  </label>
                  <input
                    type="number"
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 text-gray-900 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600 dark:focus:ring-gold-400"
                    placeholder="Ex: 40"
                  />
                </div>
                <div>
                  <label className="block text-lg font-semibold text-gray-700 dark:text-gray-100 mb-2 flex items-center">
                    <FaQuestionCircle className="mr-3 text-gold-500" />
                    Meta de Questões
                  </label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-lg font-semibold text-gray-700 dark:text-gray-100 mb-2 flex items-center">
                    <FaHourglassHalf className="mr-3 text-gold-500" />
              ...
              <div>
                <label className="block text-lg font-semibold text-gray-700 dark:text-gray-100 mb-3 flex items-center">
                  <FaCalendarAlt className="mr-3 text-gold-500" />
                  Dias de Estudo
                </label>
                <div className="flex justify-around items-center pt-4">
                  {daysOfWeek.map(day => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-full text-sm font-bold flex items-center justify-center transition-all duration-200 ${studyDays.includes(day) ? 'bg-gold-500 text-white transform scale-110 shadow-lg' : 'bg-gray-200 text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600'}`}
                      title={day}
                    >
                      {day.charAt(0)}
                    </button>
            ...
            <div className="p-6 bg-teal-50 dark:bg-gold-900/50 rounded-lg border-2 border-gold-200 dark:border-gold-700">
              <h3 className="text-xl font-bold text-gold-800 dark:text-gold-200 mb-4">Resumo do seu Planejamento</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gold-900 dark:text-gold-100">
            ...
            <div className="flex justify-between mt-8">
              ...
              <button onClick={handleGenerateCycle} className="px-6 py-2 bg-gold-500 text-white font-semibold rounded-lg hover:bg-gold-600 transition-colors dark:bg-gold-600 dark:hover:bg-gold-700">Gerar Ciclo</button>
            </div>
          </div>
        );
      case 4:
        ...
        return (
          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div className="flex items-end gap-2">
                  <div className="relative w-full" ref={manualSubjectDropdownRef}>
                    <button
                      ...
                      className="mt-1 block w-full pl-3 pr-10 py-2 text-left text-base border-2 border-gray-300 focus:outline-none focus:ring-gold-500 focus:border-gold-500 sm:text-sm rounded-md dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600 dark:focus:ring-gold-400"
                    >
                      ...
                      <div className="absolute z-20 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm dark:bg-gray-700 dark:ring-gray-600">
                        {subjects.map(s => (
                          <div
                            ...
                            className="text-gray-900 cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-gold-100 dark:text-gray-100 dark:hover:bg-gold-800"
                          >
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gold-500 focus:border-gold-500 sm:text-sm text-gray-900 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600 dark:focus:ring-gold-400"
                  placeholder="Ex: 60"
                  min="1"
                />
              </div>
            ...
            <button
              ...
              className="w-full py-2 px-4 bg-gold-500 text-white font-semibold rounded-lg hover:bg-gold-600 transition-colors mb-6 dark:bg-gold-600 dark:hover:bg-gold-700"
            >
              Adicionar Sessão
            </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div>
                <label className="block text-lg font-semibold text-gray-700 mb-2 flex items-center">
                  <FaClock className="mr-3 text-gold-500 dark:text-gold-400" />
                  Horas Semanais
                </label>
              ...
              <div>
                <label className="block text-lg font-semibold text-gray-700 mb-2 flex items-center">
                  <FaQuestionCircle className="mr-3 text-gold-500 dark:text-gold-400" />
                  Meta de Questões
                </label>
                <input
                  type="number"
                  value={weeklyQuestionsGoal}
                  onChange={(e) => setWeeklyQuestionsGoal(e.target.value)}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-gold-500 focus:border-gold-500 sm:text-sm text-gray-900 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600 dark:focus:ring-gold-400"
                  placeholder="Ex: 250"
                />
              </div>
            </div>
            <div className="mt-6">
              <label className="block text-lg font-semibold text-gray-700 mb-3 flex items-center">
                <FaCalendarAlt className="mr-3 text-gold-500 dark:text-gold-400" />
                Dias de Estudo
              </label>
              <div className="flex justify-around items-center pt-4">
                {daysOfWeek.map(day => (
                  <button
                    key={day}
                    onClick={() => handleDaySelect(day)}
                    className={`w-10 h-10 rounded-full text-sm font-bold flex items-center justify-center transition-all duration-200 ${studyDays.includes(day) ? 'bg-gold-500 text-white transform scale-110 shadow-lg dark:bg-gold-600' : 'bg-gray-200 text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600'}`}
                    title={day}
                  >
                    {day.charAt(0)}
                  </button>
            ...
            <div className="flex justify-between mt-8">
              ...
              <button onClick={handleSaveManualCycle} className="px-6 py-2 bg-gold-500 text-white font-semibold rounded-lg hover:bg-gold-600 transition-colors dark:bg-gold-600 dark:hover:bg-gold-700">Salvar Ciclo</button>
            </div>
          </div>
        );
      default:
