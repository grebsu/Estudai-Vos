      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] flex flex-col">
        <div className="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">
            Ajustar Relevância: <span className="text-gold-500">{subject.subject}</span>
          </h2>
            ...
            <div key={topic.topic_text} className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center space-x-4 w-full sm:w-1/2">
                <input
                  ...
                  className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700 range-gold"
                />
                <span className="font-bold text-gold-500 w-8 text-center">{topicWeights[topic.topic_text] || 3}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700 mt-auto">
          <button
            onClick={onClose}
            className="w-full bg-gold-600 hover:bg-gold-700 text-white font-bold py-2 px-4 rounded-lg"
          >
            Fechar
          </button>
        </div>
