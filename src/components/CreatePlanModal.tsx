...
interface CreatePlanModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (planData: { name: string; observations: string; cargo: string; edital: string; imageFile?: File; existingIconUrl?: string }) => void;
  initialPlanData?: { name: string; observations: string; cargo?: string; edital?: string; iconUrl?: string; };
  isEditing?: boolean;
}
